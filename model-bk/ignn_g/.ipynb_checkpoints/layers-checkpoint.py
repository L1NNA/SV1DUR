...
from ignn_g.utils import projection_norm_inf, projection_norm_inf_and_1, SparseDropout
from ignn_g.functions import ImplicitFunction
...
class ImplicitGraph(Module):
    ...
    def forward(self, X_0, A, U, phi, A_rho=1.0, fw_mitr=300, bw_mitr=300, A_orig=None):
        ...
        # print(torch.transpose(U, 0, 1).shape, self.Omega_1.T.shape)
