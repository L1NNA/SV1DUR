...
use crate::primitive_types::{AttackType, Mode};
use crate::event_handlers::{EventHandlerEmitter, DefaultEventHandler, EventHandler, DefaultBCEventHandler};
...
mod tests {
    ...
    fn test_attack_controller() {
        for attack_index in 1..10 {
            ...
            assert!(result.contains_key(&(attack_index as u8)) == true);
        }
    }
}